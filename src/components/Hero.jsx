...
const Hero = () => {
  return (
    <>
      <header className="relative h-[400px] md:h-[500px] lg:h-[600px] overflow-hidden md:my-20">
        <img
        ...
        <div className="absolute inset-0 flex items-center justify-center px-6 md:px-12 text-center font-tajawal">
          <h2 className="text-white text-xl sm:text-2xl md:text-4xl lg:text-5xl font-semibold flex flex-col gap-4 md:gap-6 leading-relaxed">
            ...
            <span className="text-sm sm:text-base md:text-lg lg:text-2xl text-gray-200 mt-2">
      ...
      <section className="bg-gray-50 py-12 md:py-16 font-medium text-center flex flex-col gap-6 px-6 md:px-20">
